class CreditCardsController < ApplicationController
  ...
  def create
    @credit_card = current_customer.credit_cards.build(credit_card_params)
  ...
  private
    ...
    def credit_card_params
      params.require(:credit_card).permit(:firstname, :lastname, :number, :cvv, :expiration_month, :expiration_year)
    end
end
